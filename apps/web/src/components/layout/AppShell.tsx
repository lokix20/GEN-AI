...
export function AppShell() {
  ...
  return (
    <div className="flex min-h-screen w-full max-w-full overflow-x-hidden" style={{ backgroundColor: '#F4F3EC' }}>
      <aside
      ...
      <div className="flex min-h-screen flex-1 flex-col w-full max-w-full overflow-x-hidden" style={{ backgroundColor: '#F4F3EC' }}>
        {!isCustomHeaderRoute && (
          <Topbar 
